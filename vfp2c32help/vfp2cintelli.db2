...
*--------------------------------------------------------------------------------------------------------------------------------------------------------
*< FOXBIN2PRG: Version="1.19" SourceFile="vfp2cintelli.dbf" /> (Solo para binarios VFP 9 / Only for VFP 9 binaries)
*
...
<TABLE>
	...
	<indexFile>VFP2CINTELLI.CDX</indexFile>

	<INDEXES>
		<INDEX>
			<TagName>I1</TagName>
			<TagType>REGULAR</TagType>
			<Key>IIF(TYPE="S".OR.ALLTRIM(CMD)=="{}","0","1")+IIF(EMPTY(ABBREV),"11","00")+LOWER(EXPANDED)</Key>
			<Filter></Filter>
		...
		<INDEX>
			<TagName>I2</TagName>
			<TagType>REGULAR</TagType>
			<Key>IIF(TYPE="S".OR.ALLTRIM(CMD)=="{}","0","1")+LOWER(EXPANDED)</Key>
			<Filter></Filter>
			<Order>ASCENDING</Order>
			<Collate>MACHINE</Collate>
		</INDEX>
