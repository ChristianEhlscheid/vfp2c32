...
*--------------------------------------------------------------------------------------------------------------------------------------------------------
*< FOXBIN2PRG: Version="1.19" SourceFile="ctypedefs.dbf" /> (Solo para binarios VFP 9 / Only for VFP 9 binaries)
*
...
<TABLE>
	...
	<indexFile>CTYPEDEFS.CDX</indexFile>

	<INDEXES>
		<INDEX>
			<TagName>ITYPEDEF1</TagName>
